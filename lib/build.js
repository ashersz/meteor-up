...
function buildApp(appPath, build_env, meteorBinary, buildLocaltion, callback) {
  buildMeteorApp(appPath, build_env, meteorBinary, buildLocaltion, function(code) {
    if(code == 0) {
...
function buildMeteorApp(appPath, build_env, meteorBinary, buildLocaltion, callback) {
